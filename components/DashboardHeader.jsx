...
export default function DashboardHeader() {
  return (
    <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 mb-6">
      <div>
        <h1 className="text-sm font-semibold text-[#242529] font-sans mb-1">
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <button className="flex items-center gap-2 px-3 sm:px-4 py-2 text-sm text-black bg-white border border-gray-300 rounded-lg hover:bg-gray-50 font-sans">
          <Calendar />
